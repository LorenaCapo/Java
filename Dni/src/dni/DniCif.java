...
public class DniCif { 
		...
		private String dni  = null; 
 		...
 		//Expresión Regular.
 		public Boolean checkDniOrNie(String cadena){
 			String dniONie = cadena.trim(); //guardar la cadena quitando espacios
 			//Declaración expresión regular
 			String expresionRegular = "(([X-Z]{1})(\\d{7})([ABCDEFGHJKLMNPQRSTVWXYZ]{1}))|((\\d{8})([[ABCDEFGHJKLMNPQRSTVWXYZ]]{1}))";
 			
 			boolean check = Pattern.matches(expresionRegular, dniONie);
